...
def adam_schedule(net, lr=1e-6):
    net_parameters_id = {}
    for pname, p in net.named_parameters():
        if (not pname.endswith(".bias")) and (
                'conv1' in pname or 'conv2' in pname or 'conv3' in pname or 'conv4' in pname):
            print(pname, 'lr:1')
        ...
        elif (not pname.endswith(".b")) and (
                'norm1' in pname or 'norm2' in pname or 'norm3' in pname or 'norm4' in pname):
            print(pname, 'lr:0.1')
